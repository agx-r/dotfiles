...
add-highlighter shared/ats2/code/keywords regex \b(if|then|else|let|in|end|case|case\+|of|and|overload|with|extern|staload|dynload)\b 0:keyword
add-highlighter shared/ats2/code/types regex \b(fun|fn|val|implement|dataprop|prop|datatype|abstype|absview|viewprop|absvtype|sortdef|datasort|stadef|vtype|view)\b 0:type
