...
(define launch-items
  '((" floorp"           . "floorp")
    ...
    ("󰜉 reboot"           . "lxqt-sudo reboot")
    ("󰐥 shutdown"         . "lxqt-sudo shutdown")
    ("󰐥 poweroff"         . "lxqt-sudo shutdown")
    ("󰃠 brightness MAX"   . "lxqt-sudo brightnessctl set 15")
    ("󰃟 brightness DEF"   . "lxqt-sudo brightnessctl set 10")
    ("󰃞 brightness MIN"   . "lxqt-sudo brightnessctl set 0")
    ("󰖩 nmtui"            . "foot -e sudo nmtui")
